...
class RlModel():
    ...
    def get_gradient_update_from_batches(self, batches):
        ...
        with self.__action_context.as_default():
            ...
            print("old gradient:",original_weights[0])
        ...
        print('new gradients:',new_weights[0])
    ...
    def get_random_state(self):
        print(np.random.randint(low=0, high=(self.__nb_actions) - 1)) 
        #return np.random.choice(self.__nb_actions, 1)[0]
        return np.random.randint(low=0, high=(self.__nb_actions) - 1)#->완전 랜덤이 아니라서 바꿨음
